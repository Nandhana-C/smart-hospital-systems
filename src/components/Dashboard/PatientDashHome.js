      ...
      <Box>
            <Paper elevation={10} style={paperStyle}>
              ...
              <Grid style={divStyle}>
                ...
                <Typography style={typoStyle} variant='h6'>MOBILE NO: 1234567890</Typography>
                <Typography style={typoStyle} variant='h6'>EMAIL: XYZ@HH.COM</Typography>
                <Typography style={typoStyle} variant='h6'>BLOOD GROUP: O+</Typography>
                <Typography style={typoStyle} variant='h6'>CURRENT MEDICATION: DOLO 650</Typography>
              </Grid>
            </Paper>
        </Box>
        <Box>
